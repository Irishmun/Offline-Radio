...
namespace OfflineRadio.UI
{
    class ButtonUIOLD
    {
        ...
        public ButtonUIOLD(Bitmap image, int buttonsX, int buttonsY, Point topLeftStart, Point bottomRightEnd)
        {
            _buttonImage = image;
            _buttonsX = buttonsX;
            _buttonsY = buttonsY;
        ...
        public ButtonUIOLD(Bitmap image, int buttonsX, int buttonsY)
        {
            _buttonImage = image;
            _buttonsX = buttonsX;
            _buttonsY = buttonsY;
